    ...
    <script type="text/javascript">
        $(function () {
            $("button.addToCart").click(function () {
                ...
                <%--location.href = "${bathPath}cartServlet?action=ajaxAddItem&id=" + bookId;--%>

                //发ajax请求，添加商品到购物车
                $.getJSON("${bathPath}cartServlet?", "action=ajaxAddItem&id=" + bookId, function (data) {
